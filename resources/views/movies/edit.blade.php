        ...
        <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-md-5">
                    ...
                    {{-- Form Header --}}
                    <h1 class="h2 fw-bold">Edit Movie Review</h1>
                    <p class="text-muted mb-4">Make changes to your review below.</p>
                    ...
                    <form action="{{ route('movies.update', $movie->id) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="release_year" name="release_year" 
                                       min="1888" max="{{ date('Y') }}" 
                                       value="{{ old('release_year', $movie->release_year) }}" placeholder="E.g., 2023">
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('movies.show', $movie->id) }}" class="btn btn-outline-secondary btn-lg">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
