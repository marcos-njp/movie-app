    ...
    <form action="{{ route('movies.update', $movie->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control" id="poster_url" name="poster_url"
                placeholder="https://example.com/image.jpg" value="{{ old('poster_url', $movie->poster_url) }}">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="genre" name="genre">
                {{-- Logic to check old input first, then the movie's saved genre --}}
                @php $selectedGenre = old('genre', $movie->genre); @endphp

                <option value="" disabled @if (!$selectedGenre) selected @endif>Choose a genre</option>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="review_content" name="review_content" rows="5">{{ old('review_content', $movie->review_content) }}</textarea>
        </div>
